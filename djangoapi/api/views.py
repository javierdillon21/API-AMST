...
from api.models import Sensores, Lecturas
from api.serializer import SensoresSerializer, LecturasSerializer
...
def sensor_data_detail(request, pk): 
    try:
        ...
        if request.method == 'GET':
            ...
            sensor_data.delete()
            return JsonResponse(
                {'message': 'sensor data was deleted successfully!'},status=status.HTTP_204_NO_CONTENT) 
